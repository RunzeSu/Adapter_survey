...
class Dataloader():
    def __init__(self, data_type = "glue"):
    ...
    def download_glue(self, data_dir):
        
    
    
    def load_glue_data(self, data_dir, tasks, max_seq_length, local_rank, train_batch_size, task_id = 0):
