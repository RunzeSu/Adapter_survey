...
class BertModel(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, i=0, task=None, task_embedding=None):
...
class BertForMultiTask(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, task_id, task='cola', labels=None, **kwargs):
        task_id = [i for i in range(len(self.adapter_config.tasks)) if self.adapter_config.tasks[i] == task][0]
